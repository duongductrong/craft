---
title: MacOS Widget
description: MacOS Widget is a component that allows you to display on your web.
preview: "files"
---

## Charger

import Charger from "@/blocks/macos/charger";
...
export const Charger = (props: ChargerProps) => {
  return (
